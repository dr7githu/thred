...
<head>
    ...
    <title>Revealing Navigation | Nifty - Admin Template</title>
                ...
                <div class="navbar-content">
                    <ul class="nav navbar-top-links">
                        ...
                        <li class="tgl-menu-btn">
                            <a class="mainnav-toggle reveal" href="#">
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
					...
					<li class="active">Revealing Navigation</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="active-link"><a href="layouts-offcanvas-revealing-navigation.html">Revealing Navigation</a></li>
