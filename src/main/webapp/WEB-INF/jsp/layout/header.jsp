	...
	<div id="navbar-container" class="boxed">
		...
		<div class="navbar-header">
			<a href="/nifty/demo/widget.do" class="navbar-brand">
				<img src="${bootstrapNfittyHome}img/logo_bigdata.png" alt="Nifty Logo" class="brand-icon">
		...
		<div class="navbar-content">
			...
			<ul class="nav navbar-top-links">
				...
				<!--Mega dropdown-->
				<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
				<li class="mega-dropdown"><a href="#" class="mega-dropdown-toggle">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-3">
								...
								<ul class="list-unstyled">
									...
									<li><a href="#">
											<span class="pull-right label label-danger">Hot</span>Indox
										</a></li>
				...
				<li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle">
						<i class="demo-pli-bell"></i> <span class="badge badge-header badge-danger"></span>
				...
				<!--User dropdown-->
				<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
				<li id="dropdown-user" class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
					...
					<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right panel-default">
						<ul class="head-list">
							...
							<li><a href="#">
									<span class="badge badge-danger pull-right">9</span><i class="demo-pli-mail icon-lg icon-fw"></i> Messages
								</a></li>
							<li><a href="#">
									<span class="label label-success pull-right">New</span><i class="demo-pli-gear icon-lg icon-fw"></i> Settings
								</a></li>
							<li><a href="#">
