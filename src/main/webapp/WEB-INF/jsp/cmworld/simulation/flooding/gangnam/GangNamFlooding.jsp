...
<script type="text/javascript" src="/skeleton/cmworld3/Utilities/dat.gui.min.js"></script>
...
<script type="text/javascript">
	...
	window.onload = function () {
		...
		cmworld.setWindowResizeCallback(function ()	{
			...
			var gap = 0;
			var width = window.innerWidth - 745 - gap;
			var height = window.innerHeight - 325 - gap;
			return { width: width, height: height };
		});
   		
		cmworld.option.worldTimer.setStartDateTime(2019, 7, 12, 14, 0, 0, 0);
		
		cmworld.addTileImageLayer("base", 
		...
		cmworld.addTerrainLayer("terrain", 
		...
		cmworld.addReal3DLayer("facility_build", 
		...
		m_ptlist.push({ x: 126.77126385502455, y: 37.41085388130343, z: 0 });
		...
		m_ptlist.push({ x: 126.87243930866391, y: 37.61296345846592, z: 0 });
				...
				<div class="panel panel-purple panel-colorful">
					<div class="pad-all">
						<p class="text-lg text-semibold">
							<i class="demo-pli-basket-coins icon-fw"></i> Information
						</p>
						<p class="mar-no">
							<span class="pull-right text-bold">2019/06/19</span> Date(yyyy/mm/dd)
						</p>
						<p class="mar-no">
							<span class="pull-right text-bold">PM 02:25:53</span> Time
						</p>
						<p class="mar-no">
							<span class="pull-right text-bold">127.0, 26.0</span> Location(Lon/Lat)
						</p>
						<p class="mar-no">
							<span class="pull-right text-bold">강남구 강남대로2길</span> Address(Gu street)
						</p>
						<p class="mar-no">
							<span class="pull-right text-bold">뱅뱅사거리</span> Place
						</p>
					</div>
