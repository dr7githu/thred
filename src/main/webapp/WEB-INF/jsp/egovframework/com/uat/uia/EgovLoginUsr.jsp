	...
	<div class="cls-content">
		<div class="cls-content-sm panel">
				...
				<form name="loginForm" id="loginForm" action="<c:url value='/uat/uia/actionLogin.do'/>" method="post">
					...
					<fieldset>
						<div class="login_type" style="visibility: hidden; display: none;">
							<ul id="ulLoginType">
								<li><a href="javascript:fnLoginTypeSelect('typeGnr');" id="typeGnr" title=""><spring:message code="comUatUia.loginForm.GNR" /></a></li>
								<!-- 일반 -->
								<li><a href="javascript:fnLoginTypeSelect('typeEnt');" id="typeEnt" title=""><spring:message code="comUatUia.loginForm.ENT" /></a></li>
								<!-- 기업 -->
								<li><a href="javascript:fnLoginTypeSelect('typeUsr');" id="typeUsr" title=""><spring:message code="comUatUia.loginForm.USR" /></a></li>
								<!-- 업무 -->
							</ul>
						</div>
						...
						<div class="form-group">
							...
							<label for="id" style="visibility: hidden; display: none;">${title}</label>
							<input type="text" class="form-control" placeholder="Username" name="id" id="id" maxlength="10" title="${title} ${inputTxt}" placeholder="${title} ${inputTxt}" autofocus>
						</div>
						<div class="form-group">
							<c:set var="title">
								<spring:message code="comUatUia.loginForm.pw" />
							</c:set>
							<label for="password" style="visibility: hidden; display: none;">${title}</label> 
							<input type="password" class="form-control" placeholder="Password" name="password" id="password" maxlength="12" title="${title} ${inputTxt}" placeholder="${title} ${inputTxt}">
						</div>
						<%-- 				
						<div class="form-group">
								<a href="#" onclick="fnShowLogin(1);"><spring:message code="comUatUia.loginForm.login.gpki"/></a>
								<!-- 인증서로그인 -->
								<a href="<c:url value='/uat/uia/egovGpkiIssu.do'/>"><spring:message code="comUatUia.loginForm.gpki.info"/></a>
								<!-- 인증서안내 -->
						</div>
						--%>
						<div class="checkbox pad-btm text-left">
							...
							<input type="checkbox" id="checkId" name="checkId" class="magic-checkbox" onclick="javascript:saveid(document.loginForm);" ><label for="demo-form-checkbox">아이디 저장</label>
						</div>
						<input name="userSe" type="hidden" value="USR" /> <input name="j_username" type="hidden" />

						<input class="btn btn-primary btn-lg btn-block" type="submit" class="btn_login" value="<spring:message code="comUatUia.loginForm.login"/>" onclick="actionLogin()"> <!-- 로그인  -->
					</fieldset>
				</form>
			</div>
			...
			<div class="login_input" style="display: none">
				<ul>
					<li><label for="password"><spring:message code="comUatUia.loginForm.pw" /></label> <!-- 비밀번호 --> <input type="password" name="pwd" id="" maxlength="20" title="${title} ${inputTxt}" placeholder="<spring:message code="comUatUia.loginForm.pw"/>"> <!-- 비밀번호 --></li>
					<li><input type="button" class="btn_login" value="<spring:message code="comUatUia.loginForm.login.gpki"/>" onclick="actionLogin()"> <!-- 인증서로그인 --></li>
					<li>
						<ul class="btn_idpw">
							<li><a href="#" onclick="fnShowLogin(0);"><spring:message code="comUatUia.loginForm.login.normal" /></a></li>
							<!-- 일반로그인 -->
						</ul>
						<ul class="btn_idpw">
			...
			<div class="pad-all">
				<a href="#" class="btn-link mar-rgt"onclick="goFindId(); return false;"><spring:message code="comUatUia.loginForm.idPwSearch" /></a>
				<a href="#" class="btn-link mar-lft" onclick="goRegiUsr(); return false;"><spring:message code="comUatUia.loginForm.regist" /></a>
