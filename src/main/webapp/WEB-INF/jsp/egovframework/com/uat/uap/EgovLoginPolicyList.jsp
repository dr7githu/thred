...
<link href="/skeleton/nifty-v2.9.1/demo/plugins/bootstrap-table/bootstrap-table.min.css" rel="stylesheet">
<link href="/skeleton/nifty-v2.9.1/demo/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet">
<link href="/skeleton/nifty-v2.9.1/demo/plugins/x-editable/css/bootstrap-editable.css" rel="stylesheet">

<script src="/skeleton/nifty-v2.9.1/demo/js/demo/tables-bs-table.js"></script>
<script src="/skeleton/nifty-v2.9.1/demo/plugins/x-editable/js/bootstrap-editable.min.js"></script>
<script src="/skeleton/nifty-v2.9.1/demo/plugins/bootstrap-table/bootstrap-table.min.js"></script>
<script src="/skeleton/nifty-v2.9.1/demo/plugins/bootstrap-table/extensions/editable/bootstrap-table-editable.js"></script>
		...
		<div class="bootstrap-table">
			...
			<div class="fixed-table-container" style="padding-bottom: 0px;">
				...
				<div class="fixed-table-container">
					<div class="fixed-table-loading" style="top: 41.7273px; display: none;">Loading, please wait...</div>
					<table>
						<colgroup>
							<col style="width: 20%" />
							<col style="width: 25%" />
...
<div class="panel">
	...
	<div class="panel-body">
		<table data-toggle="table" data-url="/skeleton/nifty-v2.9.1/demo/data/bs-table.json" data-show-columns="true" data-page-list="[5, 10, 20]" data-page-size="5" data-pagination="true" data-show-pagination-switch="true">
			<thead>
				<tr>
